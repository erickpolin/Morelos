...
attach(ConcMorelos) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcMorelos<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcMorelos) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcMorelos$factor,to.data.frame=TRUE)
...
ConcMorelos$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcMorelos$MAXT<-ConcMorelos$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcMorelos<-ConcMorelos[with(ConcMorelos, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcMorelos$ACUMULA<-cumsum(ConcMorelos$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcMorelos[dim(ConcMorelos[ConcMorelos$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcMorelos<-rbind(ConcMorelos[1:(dim(ConcMorelos[ConcMorelos$ACUMULA<tam_dec*i,])[1]+1),],
                             ConcMorelos[(dim(ConcMorelos[ConcMorelos$ACUMULA<tam_dec*i,])[1]+1):dim(ConcMorelos[1])[1],])
  
  b1<-tam_dec*i-ConcMorelos[dim(ConcMorelos[ConcMorelos$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcMorelos[(dim(ConcMorelos[ConcMorelos$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcMorelos[(dim(ConcMorelos[ConcMorelos$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcMorelos$ACUMULA2<-cumsum(ConcMorelos$factor)
...
ConcMorelos[(ConcMorelos$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcMorelos[((ConcMorelos$ACUMULA2>tam_dec*i)&(ConcMorelos$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcMorelos[ConcMorelos$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Morelos")
write.dbf(ConcMorelos,file="ConcMorelos2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Morelos")
write.dbf(ConcMorelos,file="ConcMorelos2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Morelos")
Conc2010<-read.dbf("ConcMorelos2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Morelos por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Morelos por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Morelos por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Morelos por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Morelos por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Morelos INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Morelos INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Morelos INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Morelos INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Morelos INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Morelos NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Morelos NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Morelos NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Morelos NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Morelos NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Morelos")
Conc2018<-read.dbf("ConcMorelos2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Morelos Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Morelos Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Morelos Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Morelos Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Morelos Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Morelos INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Morelos INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Morelos INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Morelos INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Morelos INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Morelos NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Morelos NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Morelos NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Morelos NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Morelos NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("Morelos por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("Morelos Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("Morelos NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("Morelos NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("Morelos INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("Morelos INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
